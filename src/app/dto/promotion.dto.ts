...
// Enhanced PromotionEmployee interface with appraisals
export interface PromotionEmployeeDetailed {
  id: number;
  employeeId: string;
  title: string;
  firstName: string;
...
// Detailed promotion record for individual view
export interface PromotionRecordDetailed {
  id: number;
  ...
  updatedAt: string;
  deletedAt: string | null;
  employee: PromotionEmployeeDetailed;
