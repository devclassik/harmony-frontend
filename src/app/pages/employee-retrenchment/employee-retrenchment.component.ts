...
export class EmployeeRetrenchmentComponent {
  ...
  filterTabs = [
    ...
    { label: 'Sickness', value: 'Sickness', icon: 'M5 13l4 4L19 7' },
    { label: 'Performance', value: 'Performance', icon: 'M5 13l4 4L19 7' },
    { label: 'Compensation', value: 'Compensation', icon: 'M5 13l4 4L19 7' },
  ];
